        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="p-3">
                            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                                ...
                                <div class="mt-4 text-center">
                                    <p class="text-muted mb-0">{{ __("By registering you agree to the Marmos") }} <a href="#" class="text-primary">{{ __("Terms of Use") }}</a></p>
                                </div>
                ...
                <div class="mt-5 text-center">
                    ...
                    <p>{{ __("© 2021 Marmos. Crafted with") }} <i class="mdi mdi-heart text-danger"></i> {{ __("djiogap nzoyem cedric ") }}</p>
                </div>
            </div>
        </div>
    </div>
